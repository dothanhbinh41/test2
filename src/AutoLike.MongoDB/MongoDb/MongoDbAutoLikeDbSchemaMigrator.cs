...
public class MongoDbAutoLikeDbSchemaMigrator : IAutoLikeDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbAutoLikeDbSchemaMigrator(IServiceProvider serviceProvider)
    {
