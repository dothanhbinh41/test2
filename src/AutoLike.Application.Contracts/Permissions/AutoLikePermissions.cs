...
public static class AutoLikePermissions
{
    ...
    public const string CommentPermissionGroup = $"Comment";
    public const string GetCommentPermission = $"{CommentPermissionGroup}.GetAllComment";
    public const string ApproveCommentPermission = $"{CommentPermissionGroup}.Approve";
}
